...
const ProfileHeader: React.FC<ProfileHeaderProps> = ({ name, title }) => (
  <header className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-t-2xl px-12 py-12 text-center shadow-lg">
    ...
    <div className="inline-block mb-8">
      <div className="w-20 h-20 bg-white rounded-full mx-auto flex items-center justify-center shadow-lg border-4 border-white">
    ...
    {/* User Info */}
    <div>
      <h1 className="text-white text-xl font-semibold mb-3">{name}</h1>
